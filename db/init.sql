...
INSERT INTO `datacenter`.`subscription` (`userid`,`topicid`)VALUES(1,5);
INSERT INTO `datacenter`.`subscription` (`userid`,`topicid`)VALUES(2,5);
INSERT INTO `datacenter`.`subscription` (`userid`,`topicid`)VALUES(1,6);
INSERT INTO `datacenter`.`subscription` (`userid`,`topicid`)VALUES(1,7);