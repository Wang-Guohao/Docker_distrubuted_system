...
INSERT INTO `datacenter`.`subscription` (`userid`,`topicid`)VALUES(1,10);
INSERT INTO `datacenter`.`subscription` (`userid`,`topicid`)VALUES(2,8);
INSERT INTO `datacenter`.`subscription` (`userid`,`topicid`)VALUES(3,9);
INSERT INTO `datacenter`.`subscription` (`userid`,`topicid`)VALUES(1,9);